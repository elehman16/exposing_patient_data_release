...
from experiments.utilities import (
    PatientInfo, filter_condition_code_by_count,
...
def main(model, tokenizer: BertTokenizerFast, condition_type: str, metrics_output_path: str):
...
if __name__ == "__main__":
    ...
    metrics_output_path = os.path.join(metrics_output_path, f"bert_cosine_sim/{args.condition_type}")
    os.makedirs(metrics_output_path, exist_ok=True)

    main(model, tokenizer, args.condition_type, metrics_output_path)
